        ...
        <div class="row">
          <div class="col-xl-8 col-lg-7" data-aos="fade-up">
            <div class="content">
              ...
              <p>
                Welcome to our website, a web-based information management system for historic places and structures in the Tucson area. Our website serves as a hub for residents, students, and visitors to explore the rich cultural and historical roots of the area.
              </p>
              <p>
                Our website is designed to provide users with a simpler and better way to find information about historic places in the area. By exploring our website, users will be able to gain a deeper understanding of the significance of these structures and their place in local history.
              </p>
              <p>
                We have a team of dedicated individuals with a variety of backgrounds and expertise working to expand the database of historic places, increase the quality of the website, and add more information to each place. Our team members bring skills in software development, information management, SW development, network operation, and more.
              </p>
              <p>
                Our website is meant to serve as a valuable resource for local groups interested in historic signage, such as the Department of Parks and Recreation, The Grant Road Coalition, the Jefferson Park Neighborhood, members of the Campus Community Relations Committee (CCRC), etc.
              </p>
              <p>
                Thank you for visiting our website and we hope that you find the information here useful and engaging.
              </p>
